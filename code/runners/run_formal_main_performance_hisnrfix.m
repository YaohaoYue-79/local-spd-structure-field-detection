function run_formal_main_performance_hisnrfix()
setup_paths_local();
ensure_local_pool_fast(4);

cfg = get_spd_scene_v2_config_main63_hisnrfix();
...
for iseed = 1:numel(cfg.seeds)
    ...
    for snrDb = cfg.mainSNRs
        ...
        fprintf('Patch63 done seed=%d, SNR=%+d dB\n', seed, snrDb);
    end
end
...
fprintf('Patch63 compute-only phase finished: %s\n', outDir);
end
